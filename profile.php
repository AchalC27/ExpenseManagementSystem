...
$sql = "SELECT firstname, lastname, email, mobile FROM users WHERE user_id='$userid'";
...
if (isset($_POST['save'])) {
    ...
    $sql = "UPDATE users SET firstname = '$fname', lastname='$lname',  mobile='$mobile' WHERE user_id='$userid'";
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    ...
                                    <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo $mobile; ?>" placeholder="Mobile Number">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md">
